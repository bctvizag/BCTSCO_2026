...
export default function TotalCell({ txn }) {
  const [hovered, setHovered] = useState(false)

  const detailItems = [
    { label: 'Cash', value: txn.Cash_amt },
    { label: 'Cheque', value: txn.Chq_amt },
    { label: 'Adj', value: txn.Adj_amt },
  ]
  ...
  return (
    ...
    >
      <span>
        {Number(txn.Total_amt).toLocaleString(undefined, {
          minimumFractionDigits: 2,
          maximumFractionDigits: 2,
        })}
      </span>
